            ...
            <>
              ...
              <form onSubmit={handleBrandSubmit} className="space-y-6">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white h-12 rounded-xl text-base font-medium"
                >
                  {isSubmitting ? (
            ...
            <>
              ...
              <form onSubmit={handleInvestorSubmit} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-500 hover:to-cyan-500 text-white h-12 rounded-xl text-base font-medium"
                >
                  {isSubmitting ? (
                    <Loader2 className="w-5 h-5 animate-spin" />
                  ) : (
