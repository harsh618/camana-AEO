      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Fueling the
            <span className="bg-gradient-to-r from-violet-600 to-cyan-500 bg-clip-text text-transparent"> Future of Search.</span>
          </h2>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-violet-50 to-white rounded-2xl border border-violet-200 p-8 text-center">
                ...
                <div className="flex items-start gap-4 mb-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-2xl font-bold text-violet-600">{item.percentage}%</span>
                    </div>
