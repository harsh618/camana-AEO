...
const platforms = [
  { key: 'chatgpt', name: 'ChatGPT', color: '#10b981', users: '950M users' },
  { key: 'gemini', name: 'Gemini', color: '#6366f1', users: '320M users' },
  { key: 'perplexity', name: 'Perplexity', color: '#f59e0b', users: '150M users' },
  { key: 'claude', name: 'Claude', color: '#ec4899', users: '80M users' },
];
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <span className="text-violet-600 text-sm font-semibold tracking-widest uppercase mb-4 block">The Why Now</span>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            The Migration is Here.
            <br />
            <span className="bg-gradient-to-r from-violet-600 to-cyan-500 bg-clip-text text-transparent">1.5 Billion Users</span> Have Shifted.
          </h2>
        ...
        >
          ...
          {/* Bottom callout */}
          <div className="mt-6">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-violet-600 to-violet-500 rounded-full text-white">
