      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-100 mb-6">
            ...
            <span className="text-sm text-violet-600 font-medium">The Team</span>
          </div>
          
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            A C-Suite
            <span className="bg-gradient-to-r from-violet-600 to-cyan-500 bg-clip-text text-transparent"> Built for Scale.</span>
          </h2>
