...
const milestones = [
  ...
  { week: 3, label: 'Foundation', visibility: '25%', icon: Wrench, color: 'bg-violet-100 text-violet-600' },
  { week: 5, label: 'Optimization', visibility: '55%', icon: Settings, color: 'bg-purple-100 text-purple-600' },
  { week: 8, label: 'Expansion', visibility: '95%', icon: LineChart, color: 'bg-fuchsia-100 text-fuchsia-600' },
      ...
      <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-4">
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="font-semibold text-violet-600">{data?.withPlatform}%</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-100 mb-6">
            ...
            <span className="text-sm text-violet-600 font-medium">Traction & Performance</span>
          </div>
          
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            The "Hockey Stick"
            <span className="bg-gradient-to-r from-violet-600 to-cyan-500 bg-clip-text text-transparent"> is Real.</span>
          </h2>
        ...
        >
          ...
          <div className="relative h-[350px] w-full">
            ...
            <div className="absolute top-4 right-4 md:right-20">
              <div className="bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white px-4 py-2 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-8 pt-8 border-t border-gray-100">
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <p className="text-2xl font-bold text-violet-600">{milestone.visibility}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
