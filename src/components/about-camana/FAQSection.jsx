...
function FAQItem({ faq, isOpen, onToggle }) {
  return (
    <div className="border-b border-gray-100 last:border-0">
      ...
      >
        <span className="text-lg font-medium text-gray-900 group-hover:text-red-600 transition-colors pr-4">
          {faq.question}
        </span>
        <ChevronDown 
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-100 mb-6">
            ...
            <span className="text-sm text-red-600 font-medium">FAQ</span>
          </div>
          
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Common Questions About
            <br />
            <span className="bg-gradient-to-r from-red-600 to-slate-500 bg-clip-text text-transparent">AI Search Optimization</span>
          </h2>
        </motion.div>
