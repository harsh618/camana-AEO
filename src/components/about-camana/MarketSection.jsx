  ...
  return (
    <section className="py-24 bg-gray-50 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <span className="text-red-600 text-sm font-semibold tracking-widest uppercase mb-4 block">Market Opportunity</span>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Capturing the
            <span className="bg-gradient-to-r from-red-600 to-slate-500 bg-clip-text text-transparent"> $600B</span>
