      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-100 mb-6">
            ...
            <span className="text-sm text-red-600 font-medium">The Moat</span>
          </div>
          
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            We Don't Guess.
            <br />
            <span className="bg-gradient-to-r from-red-600 to-slate-500 bg-clip-text text-transparent">We Engineer Authority.</span>
          </h2>
        ...
        >
          <div className="grid md:grid-cols-2 gap-4 md:gap-0">
            ...
            {/* Modern Column */}
            <div className="bg-gradient-to-br from-red-50 to-slate-50 rounded-2xl md:rounded-l-none border border-red-200 overflow-hidden">
              <div className="p-6 bg-red-100 border-b border-red-200">
                <div className="flex items-center justify-center gap-2">
                  <Zap className="w-5 h-5 text-red-600" />
                  <h3 className="text-lg font-semibold text-red-700">Our AI-Enhanced Process</h3>
                </div>
              </div>
              <div className="p-6 space-y-4">
                {comparisons.map((item, index) => (
