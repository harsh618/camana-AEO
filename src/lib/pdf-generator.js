...
export function generateVisibilityReport(userData) {
    ...
    doc.text('Powered by Camana Homes AI Discovery Engine', pageWidth / 2, 30, { align: 'center' });
    ...
    doc.text('© 2026 Camana Homes AI Discovery Engine', pageWidth / 2, pageHeight - 10, { align: 'center' });
